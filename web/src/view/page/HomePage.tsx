    ...
    <Page>
      ...
      <Form>
        <Form.Group>
          ...
          <Form.Text className="text-muted">Input your desired username.</Form.Text>
        </Form.Group>
