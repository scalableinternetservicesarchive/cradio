    ...
    <>
      ...
      <BodyText>
        <ul className="pl4">
          ...
          <li>
            Must use the class project framework located <Link href="https://github.com/rothfels/cradio">here</Link>
          </li>
            ...
            checklistFull={[
              {
                ...
                href: 'https://github.com/rothfels/cradio#quickstart',
              },
              {
              ...
              },
              {
                ...
                href: 'https://github.com/rothfels/cradio#run-react-storybook',
              },
            ]}
          />
          <Sprint
