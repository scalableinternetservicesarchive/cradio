...
# Lambda URIs are "{+lambda}/{+function}" e.g. "cradio/ping".
# We also support path matching at the root e.g. "cradio" but these require definining separate "_root" terraform resources.
