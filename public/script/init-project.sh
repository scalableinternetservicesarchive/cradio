...
git clone https://github.com/rothfels/cradio.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/cradio/$SLUG/g" **/*.tf
sed -i.bak "s/cradio/$SLUG/g" **/*.ts
sed -i.bak "s/cradio/$SLUG/g" **/*.yml
sed -i.bak "s/cradio/$SLUG/g" **/*.sh
sed -i.bak "s/cradio/$SLUG/g" **/*.json
rm -rf **/*.bak
