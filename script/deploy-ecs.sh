...
usage="Usage: deploy-ecs.sh [cradio-app-web|cradio-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/cradio:$2"
...
aws ecs update-service --cluster cradio \
  --no-cli-pager \
  --region "$ecs_region" \
